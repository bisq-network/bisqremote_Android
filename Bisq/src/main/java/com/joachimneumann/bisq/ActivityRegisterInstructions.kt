...
class ActivityRegisterInstructions : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webcamButton.setOnClickListener { startActivity(Intent(this, ActivityRegisterQR::class.java)) }
        emailButton = bind(R.id.register_email_button)
        emailButton.setOnClickListener { startActivity(Intent(this, ActivityRegisterEmail::class.java)) }
    }
}
